...
$search = $_GET['search'] ?? '';
$students = searchData('siswa', ['nis', 'nama'], $search, 'nama ASC');
      ...
      <div class="overflow-x-auto">
        <table class="min-w-full bg-white">
          <thead class="bg-blue-500">
            <tr>
              <th class="py-3 px-6 text-left text-xs font-bold text-white-200 uppercase tracking-wider">No</th>
              <th class="py-3 px-6 text-left text-xs font-bold text-white-200 uppercase tracking-wider">NIS</th>
              <th class="py-3 px-6 text-left text-xs font-bold text-white-200 uppercase tracking-wider">Nama</th>
              <th class="py-3 px-6 text-center text-xs font-bold text-white-200 uppercase tracking-wider">Aksi</th>
            </tr>
          </thead>
